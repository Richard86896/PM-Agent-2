...
默认主题：**橙白经典**（主色 `#FF6B00`）。支持 5 套主题，详见 [references/themes.md](./references/themes.md)。
...
| 主题风格（5套主题） | [references/themes.md](./references/themes.md) |
...
**触发条件**：用户首次发起原型构建、或明确表示是新项目时。

执行步骤：
1. 根据用户描述的项目类型/业务场景，对照 [references/themes.md](./references/themes.md) 中的「场景匹配规则」，**自动推荐最合适的主题**
2. 简要说明推荐理由（1-2 句话）
3. 列出全部 5 套主题供用户参考选择
4. **等待用户确认主题后，再开始生成任何代码**

> 示例输出：
> 「根据您描述的财务对账场景，推荐使用**绿色清简**主题（清爽、信任感强）。您也可以选择其他主题：橙白经典 / 蓝色科技 / 暗黑专业 / 紫色商务。请确认后我开始生成代码。」
